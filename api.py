#!/usr/bin/env python3
"""
Vortex Panel - Comprehensive REST API
Full management API for Vortex Panel
"""
...
def api_info():
    ...
    return jsonify({
        'success': True,
        'api': {
            'name': 'Vortex Panel API',
            'version': 'v1',
            'description': 'Comprehensive REST API for Vortex Panel management',
